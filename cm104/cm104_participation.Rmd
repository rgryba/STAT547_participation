...
```{r}
comm_fun <- function(x,y) paste(x, "takes", y, "minutes to get to work.")
...
```{r}
map2(name, commute, function(t, s) paste(t, "takes", s, "minutes to get to work." ))
```

3. By defining a formula.

```{r}
map2(name, commute, ~ paste(.x, "takes", .y, "minutes to get to work."))
```
